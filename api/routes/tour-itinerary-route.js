...
import { createitinerary, deleteIntinerary, deleteIntineraryForUpdate, getAllIntineraryTour, getIntinerary, updateIntinerary } from "../Controller/tour-itinerary.js";
...
router.post('/itinerary/update/id/', async (req, res) => {
